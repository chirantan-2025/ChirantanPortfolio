...
const WORDS = ["Computer Application Student", "Tech Enthusiast","Frontend Developer","MERN Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind","Next"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/chirantan-2025" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/chirantan-bramhachari-93682127a/" },
  { icon: Instagram, link: "https://www.instagram.com/its.chirantan.21/" },
];
